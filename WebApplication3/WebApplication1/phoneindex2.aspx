...
<body>
    ...
    <div>
        ...
        <div class="textbox">
            ...
            <asp:Button ID="Button4" runat="server" Text="Αποστολή Επαφής" OnClick="Button4_Click" BackColor="#006600" ForeColor="White" Font-Names="Calibri" Height="24px" Width="128px" CssClass="button rounded" />

            <asp:Button ID="Button1" runat="server" Text="Ενημέρωση" OnClientClick="Confirm()" OnClick="Button1_Click" BackColor="#006699" ForeColor="White" Font-Names="Calibri" Height="24px" Width="99px" CssClass="button rounded" />
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Αποθήκευση" BackColor="#006699" ForeColor="White" Font-Names="Calibri" Height="24px" Width="99px" CssClass="button rounded" />
            <asp:Button ID="Button2" runat="server" Text="Διαγραφή" OnClientClick="Confirm()" OnClick="Button2_Click" BackColor="Red" ForeColor="White" Font-Names="Calibri" Height="24px" Width="99px" CssClass="button rounded" />
